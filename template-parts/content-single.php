...
<h1 class="text-brandGreen mb-10 text-xl md:text-3xl font-hanken font-bold"><?php the_title(); ?></h1>
...
<main class="flex flex-col gap-15 lg:flex-row">
	...
	<aside class="basis-2/5 space-y-7">
		<h2 class="cursor-pointer text-2xl font-antonio font-bold text-darkGreen hover:text-darkGreen/80 transition-all transition-duration-150"><a href="<?php echo esc_url(get_permalink(get_page_by_path('noticias')));?>">Más Noticias</a></h2>
