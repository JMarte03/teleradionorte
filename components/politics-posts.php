            ...
            <?php foreach ($posts_array as $index => $post) : ?>
                <?php if ( $index > 0 ) : ?>
                    <a href="<?php echo esc_url($post['link']); ?>" class="">
                        <div class="border-t border-white pt-5 flex flex-col gap-y-5 lg:pt-0 lg:border-0 hover:scale-95 transition-all transition-duration-300">
                            <span class="uppercase w-fit font-hanken text-sm text-white pt-2 lg:border-t border-white/50 lg:w-full lg:pt-6"><?php echo esc_html($post['categoria']);?></span>
