...
<main class="pb-8 mt-4 px-12 lg:mt-12">
	...
	<section class="w-full flex flex-col gap-x-12 gap-y-8 lg:flex-row">
		<div class="ctn bg-white z-10">
			<video id="player" controls crossorigin playsinline class="relative aspect-video lg:min-h-96 lg:max-h-96 bg-stone-100">
		...
		<div class="flex-grow lg:h-96">
			...
			<!-- descripción -->
			<div id="programa-hoy" class="lg:overflow-y-auto lg:h-75 mt-8 w-full">
				<ul class="space-y-2">
